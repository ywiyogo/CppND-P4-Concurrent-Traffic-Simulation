...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    std::cout << "Intersection #" << _id << "::addVehicle#"<< vehicle->getID()<<" to queue: thread id = " << std::this_thread::get_id() << std::endl;
    lck.unlock();
    ...
    {
        std::cout << "Intersection #" << _id << " TL #" << _trafficLight.getID() << " is red and waiting for green"<<std::endl<<std::flush;
        _trafficLight.waitForGreen();
        std::cout << "Intersection #" << _id << " TL #" << _trafficLight.getID() << " switched to green"<<std::endl<<std::flush;
    }
